...
<%@include file="./layout/header.jsp"%>
  ...
  <main id="main">
    ...
    <!--pick your favorite 메뉴페이지로 이동-->
    <section id="favWrap" class="winter_fav_bg">
      <div class="wrap_inner">
          <div id="fav_prod" class="fav_prod_txt01" style="opacity: 1; left: 280px;">
            PICK YOUR FAVORITE</div>
          <div id="fav_prod" class="fav_prod_txt02" style="opacity: 1; left: 182px;">
            다양한 메뉴를 스타벅스에서 즐겨보세요. 스타벅스만의 특별함을 경험할 수 있는 최상의 선택 음료, 
  ...
  <!--storeWrap 스토어페이지로 이동-->
  <section id="storeWrap">
    <div class="wrap_inner">
      <div class="store_exp_img01" style="opacity: 1;"></div>
      <div class="store_exp_img02" style="opacity: 1;"></div>
      <div class="store_exp_img03" style="opacity: 1;"></div>
