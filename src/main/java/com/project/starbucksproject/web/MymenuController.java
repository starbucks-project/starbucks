...
public class MymenuController {
  ...
  /*
   * @GetMapping("/user/mymenu/{id}") public String mymenu(@PathVariable int
   * id,Model model) { Product productEntity=productRepository.findById(id).get();
   * model.addAttribute("productEntity",productEntity); return
   * "auth/drink_detail"; }
   */
