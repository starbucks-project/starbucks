  ...
  <main id="main">
    ...
    <div class="sub_tit_wrap">
      <div class="sub_tit_inner">
        <h2><img src="/images/food_list/menu_tit2.jpg" alt="푸드"></h2>
      </div>
    </div>
    <!-- 서브 타이틀 end -->
    <div class="content">
              ...
              <div class="product_list">
                <dl>
                  ...
                  <dt style="display: block;">
                    <a href="javascript:void(0);">브레드 / 케이크 / 샌드위치&샐러드</a>
                  </dt>
                  <dd style="display: block;">
                    <ul class="product_cold_brew">
                        ...
                        <li class="menuDataSet" new="Y" sell="" recomm="0" sold="N">                 
                          <dl>                     
                            <dt>                         
                              <a href="/auth/food_detail/${product.id}" class="goDrinkView" prod="9200000003643">
                                <img src="/images/food_list/${product.productImg}" alt="아이스크림 블렌딩 콜드 브루">
                              </a>                                                  
                              <ul>                                                          
                                <li>
